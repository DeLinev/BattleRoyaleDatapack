...
execute if score #teams_count globals matches 3 positioned -3 201 -2 run function battle_royale:teams/create_team_block { \
  offset:3, \
...
execute if score #teams_count globals matches 4 positioned -3 201 -2 run function battle_royale:teams/create_team_block { \
  offset:4, \
