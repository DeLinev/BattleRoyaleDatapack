# Updates bossbar value based on remaining/total time ratio
# Input: storage br:temp { remaining_time: <int>, all_time: <int> }
# Output: bossbar br:border value set to percentage (0-100)
